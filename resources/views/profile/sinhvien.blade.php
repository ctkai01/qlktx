                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="masv" name="masv"
                                        value="{{ $owner ? $owner->MaSV :old('masv') }}"/>
                                    @if ($errors->has('masv'))
                                ...
                                <div class="mb-3">
                                    ...
                                    <div style="display: flex; justify-content: space-around">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="gender" value="1"  {{ $owner->GioiTinh == 'Nam' ? 'checked' : ''; }}/>
                                            <label class="form-check-label"  for="inlineRadio2">Nam</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" {{ $owner->GioiTinh == 'Nam' ? '' : 'checked'; }} type="radio" name="gender" value="0" />
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="class" name="class"
                                        value="{{ $owner ? $owner->Lop : old('class') }}" />
                                    @if ($errors->has('class'))
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="khoa" name="khoa"
                                        value="{{ $owner ? $owner->Khoa : old('khoa') }}" />
                                    @if ($errors->has('khoa'))
