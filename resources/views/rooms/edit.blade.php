@extends('layouts.app')
@section('title_for_layout', 'Chỉnh sửa phòng')
@section('css')
...
@section('content')
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <form action="{{ route('rooms.update', $room->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row" style="justify-content: center">
                    ...
                    <div class="col-md-6">
                        <div class="card mb-4">
                            <h5 class="card-header">Sửa thông tin phòng</h5>
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="name_room" name="name_room"
                                        value="{{ $room ? $room->MaPhong : old('name_room') }}" />
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="type_room" class="form-select" name="type_room">
                                        ...
                                        <option value="1" {{ $room->LoaiPhong ? 'selected' : '' }}>Vip</option>
                                        <option value="0" {{ $room->LoaiPhong ? '' : 'selected' }}>Thường</option>
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="price" name="price"
                                        value="{{ $room ? $room->GiaPhong : old('price') }}" />
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="number_people" name="number_people"
                                        value="{{ $room ? $room->SoNguoi : old('number_people') }}" />
                            ...
                            <div style="display: flex; justify-content: center; padding-bottom: 20px">
                                <button type="submit" style="width: 300px" class="btn btn-primary">Cập nhật phòng</button>
                            </div>
                        </div>
                    </div>
    ...
    @push('after-scripts')
        ...
        <script>
            ...
            images =
                images = JSON.parse(JSON.stringify(<?php 
                $media = $room->media;
                $media = $media->map(function ($img) {
                    return $img->Ten;
                });
